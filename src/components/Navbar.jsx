        ...
        <nav className="flex md:justify-start justify-between gap-4 items-center w-full md:pt-15 md:px-30 pt-5 px-5 bg-white max-w-7xl mx-auto">
            ...
            <div className={`fixed top-0 right-0 h-screen bg-white shadow-2xl z-10 flex flex-col gap-6 pt-12 px-16 transition-transform duration-300 ease-in-out transform ${showMenu ? 'translate-x-0' : 'translate-x-full'} md:static md:h-auto md:flex-row md:justify-between md:bg-[#f5f5f5] md:shadow-none md:p-1 md:gap-1 md:rounded-lg md:translate-x-0 w-full`}>
                ...
                <ul className="flex flex-col md:flex-row m-0 p-0 list-none">
                    ...
                    <li className={`rounded-lg transition-colors duration-300 ${activeMenu === "CONTACT" ? "bg-white" : ""}`}>
                        <button
                            className="text-sm leading-[24px] font-bold cursor-pointer bg-transparent py-2 px-4 border-none w-full"
                    ...
                    <li className={`rounded-lg transition-colors duration-300 ${activeMenu === "ABOUT" ? "bg-white" : ""}`}>
                        <button
                            className="text-sm leading-[24px] font-bold cursor-pointer bg-transparent py-2 px-4 border-none w-full"
                ...
                <div className="flex flex-col md:flex-row gap-2">
                    <button className="text-sm leading-[24px] font-bold cursor-pointer bg-transparent py-2 px-4 rounded-lg transition-colors duration-300 border-none">
                        Login
                    </button>
                    <button className="text-sm leading-[24px] font-bold cursor-pointer bg-transparent py-2 px-4 rounded-lg transition-colors duration-300 border-solid border-1 border-[#595D62]">
                        Sign Up
                    </button>
                </div>
            </div>
